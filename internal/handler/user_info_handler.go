...
func GetInfo(c *gin.Context) {
	...
	if !ok {
		c.JSON(http.StatusBadRequest, gin.H{"description": "Неавторизован."}) //TODO
		return
	}
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"description": "Внутренняя ошибка сервера."}) //TODO
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"coins":                  balance,
		"merch":                  inventory,
		"transactions from user": transactionFromUser,
		"transactions to user":   transactionToUser,
	})
}
